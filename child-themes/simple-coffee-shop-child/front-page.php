...
<main id="main" class="container" style="padding: 2.5rem 0;">
  ...
  <section class="card" style="margin-bottom: 2rem;">
    <h2 class="section-title" style="margin-bottom: 1rem;">Welcome to Our Coffee Shop</h2>
    <p class="lead">Enjoy a warm atmosphere with the best coffee in town.</p>
  </section>
  <section class="card" style="margin-bottom: 2rem;">
    <h2 class="section-title" style="margin-bottom: 1rem;">Our Menu</h2>
    <p class="lead">We offer a variety of coffee blends and fresh pastries.</p>
  </section>
  <section class="card" style="margin-bottom: 2rem;">
    <h2 class="section-title" style="margin-bottom: 1rem;">Visit Us</h2>
    <p class="lead">Stop by for a cup of your favorite brew!</p>
  </section>
</main>
<?php get_footer(); ?>
