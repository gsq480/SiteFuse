...
<main id="main" class="container" style="padding: 2.5rem 0;">
  ...
  <section class="card" style="margin-bottom: 2rem;">
    <h2 class="section-title" style="margin-bottom: 1rem;">Hero</h2>
    <p class="lead">Bold Tagline</p>
  </section>
  <section class="card" style="margin-bottom: 2rem;">
    <h2 class="section-title" style="margin-bottom: 1rem;">About Us</h2>
    <p class="lead">Story of the café</p>
  </section>
  <section class="card" style="margin-bottom: 2rem;">
    <h2 class="section-title" style="margin-bottom: 1rem;">Our Coffee</h2>
    <p class="lead">Images of espresso drinks</p>
  </section>
  <section class="card" style="margin-bottom: 2rem;">
    <h2 class="section-title" style="margin-bottom: 1rem;">Testimonials</h2>
    <p class="lead">Carousel of customer reviews</p>
  </section>
  <section class="card" style="margin-bottom: 2rem;">
    <h2 class="section-title" style="margin-bottom: 1rem;">Call to Action</h2>
    <p class="lead">Book a Table button</p>
  </section>
</main>
<?php get_footer(); ?>
