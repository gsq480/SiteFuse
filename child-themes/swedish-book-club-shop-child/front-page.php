      ...
      <div class="grid lg:grid-cols-2 gap-12 items-center">
        <div>
          ...
          <p class="text-gray-600 mb-8 leading-relaxed">
            <?php echo esc_html($website_data["pages"][0]["content"][0]["paragraph"] ?? "Our team combines expertise, innovation, and personalized service to help you achieve your goals. We believe in building lasting relationships based on trust, quality, and results."); ?>
          </p>
